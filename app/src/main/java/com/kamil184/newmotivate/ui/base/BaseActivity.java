package com.kamil184.newmotivate.ui.base;
...
public class BaseActivity extends AppCompatActivity {
    ...
    public void hideProgress() throws NullPointerException {
    ...
    public void attemptToExitIfRoot(@Nullable View anchorView) {
        if (isTaskRoot()) {
            if (backPressedTime + DOUBLE_CLICK_TO_EXIT_INTERVAL > System.currentTimeMillis()) {
                super.onBackPressed();
            } else {
                if (anchorView != null) {
