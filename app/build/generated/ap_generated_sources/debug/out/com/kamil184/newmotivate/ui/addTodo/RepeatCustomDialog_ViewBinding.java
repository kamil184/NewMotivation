...
public class RepeatCustomDialog_ViewBinding implements Unbinder {
  private RepeatCustomDialog target;

  @UiThread
  public RepeatCustomDialog_ViewBinding(RepeatCustomDialog target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RepeatCustomDialog target = this.target;
